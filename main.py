from utils.human_detector import load_inference_graph
from utils.human_detector import detect_objects

import os
from datetime import datetime
import cv2
from utils import draw_bbox_cv2
import sys
...
def run_detections(web_cam, path_vid, im_height, im_width, score_thresh):
        ...
        while True:
            ...
            boxes, scores, classes, num_detections = detect_objects(frame, detection_graph, sess)
            ...
            #
            bbox_cords = draw_bbox_cv2.extract_box_and_plot(boxes, scores, classes, num_detections,score_thresh, im_width, im_height, frame)
